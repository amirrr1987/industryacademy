...
class Cdb_Course_Categories extends Widget_Base {
	...
	public function get_title() {
		return  __( 'Course Categories', 'studiare' );
	}
...
<div id="<?php echo $jp_id;?>" class=" cats_grid_view">
     ...
     foreach ( $product_categories as $category ) {
        ...
        $sc_studi_cat_color = get_term_meta($category->term_id, 'sc_studi_cat_color', true)?:"var(--primary_color)";
            ...
            <div class="edu_cat_3 cat-<?php echo $catNum;?>" >
				...
				<div class="edu_cat_data">
									...
									<ul class="edu_cat_meta">
										...
										if($studi_cat_type=='st_course'){ echo sprintf( _n( '%s Course', '%s Courses', $category->count, 'studiare' ), $category->count ); }else { echo sprintf( _n( '%s Product', '%s Products', $category->count, 'studiare' ), $category->count );}
										?>
										</li>
									</ul>
				</div>
