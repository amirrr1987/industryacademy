                ...
                <ul class="studiare-social-links rounded">
	                <?php foreach($origin_socials as $social): ?>
	                    ...
	                    <?php if(!empty($current_social[0])): ?>
                            <li>
                                <a class="<?php echo esc_attr($social); ?> hint--top" href="<?php echo esc_url(($current_social[0])); ?>" target="_blank" aria-label="<?php echo esc_attr__('مشاهده مدرس در ', 'studiare').' '.$social ?>">
