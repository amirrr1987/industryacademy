...
<div <?php wc_product_class( 'course-item inprolay3' ); ?>>
...
?>    
        ...
        <div class="course-content-holder sc_equal_height_item" <?php echo $borderStyle; ?>>
            ...
            <div class="course-content-main">
                ...
                <?php //if ( $comments_num  ) : ?>
                    <div class="course-rating-teacher">
                        ...
                        <div class="sc-teacher hint--top-right" aria-label="<?php echo esc_html_e('View Profile', 'studiare' ); ?>">  <i class="fal fa-chalkboard-teacher"></i>  <a href="<?php echo esc_url( get_the_permalink( $teacher_id ) ); ?>" class="course-loop-teacher"><?php echo esc_attr( get_the_title( $teacher_id ) ); ?></a></div>
                        <?php endif; ?>
