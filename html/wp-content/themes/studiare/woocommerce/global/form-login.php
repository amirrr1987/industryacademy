...
if($otp_situ == "1"){
?>
<div class="studi_checkout_login woocommerce-form woocommerce-form-login login" <?php echo ( $hidden ) ? 'style="display:none;"' : ''; ?>>
<?php 

                $lwe = __('With Email','studiare');
                $lwm = __('With Mobile','studiare');
                echo "<div class='sclogin_switch mb-30'><a data-divtoinactive='otp_login_frm_incheckout' data-divtoactive='default_login_frm_incheckout' class='scls_btn scls_active' href='#'><i class='fal fa-envelope'></i> $lwe</a><a data-divtoinactive='default_login_frm_incheckout' data-divtoactive='otp_login_frm_incheckout' class='scls_btn' href='#'><i class='fal fa-mobile'></i> $lwm</a></div>";
            
            //adding otp to login page
            echo "<div id='otp_login_frm_incheckout' style='display:none;'>";
            //echo do_shortcode("[suncode_otp_login_form]");
            echo "</div>";
            
?>
<form id="default_login_frm_incheckout" class="woocommerce-form woocommerce-form-login login" method="post" >
