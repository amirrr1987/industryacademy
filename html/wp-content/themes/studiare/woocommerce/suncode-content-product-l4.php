...
if($product_category_border==1){
            ...
            <div class="course-content-main">
                ...
                <?php //if ( $comments_num  ) : ?>
                    <div class="course-rating-teacher">
                        ...
                        <div class="sc-teacher">  <i class="fal fa-chalkboard-teacher"></i>  <a href="<?php echo esc_url( get_the_permalink( $teacher_id ) ); ?>" class="course-loop-teacher hint--top-right" aria-label="<?php echo esc_html_e('View Profile', 'studiare' ); ?>"><?php echo esc_attr( get_the_title( $teacher_id ) ); ?></a></div>
                        <?php endif; ?>
    ...
    <?php if ( has_excerpt() ) { ?>
            ...
            <div class="course-content-bottom sc-bottom-four" >
                    ...
                    /** since v 12.5 **/
                        ...
                        if($product->is_purchasable() && $addtocartinshopOK=="true" && $product->is_in_stock()){
                            ...
                            echo apply_filters( 'woocommerce_loop_add_to_cart_link',
                                sprintf( '<a href="%s" rel="nofollow" data-product_id="%s" data-product_sku="%s" class="single_add_to_cart_button button alt studi_add_in_lfour %s product_type_%s ajax_add_to_cart">%s</a>',
                                    esc_url( $product->add_to_cart_url() ),
                                    esc_attr( $product->get_id() ),
                                    esc_attr( $product->get_sku() ),
                                    $product->is_purchasable() ? 'add_to_cart_button' : '',
                                    esc_attr( $product->get_type() ),
                                    __('Add to Cart', 'studiare' )
                                ),
                            $product );
                            
                        }else{
                            
                            echo '<a href="'.get_permalink().'" rel="nofollow"  class="studi_add_in_lfour single_add_to_cart_button button alt">'.__("View More", "studiare" ).'</a>';
