...
vc_map( array(
	...
	'name'             => esc_html__( 'نظرات مشتریان ۲', 'studiare' ),
	'description'      => esc_html__( 'نمایش اسلایدی یا مشبک نظرات مشتریان', 'studiare' ),
	'as_parent'        => array('only' => 'sc_testimonial_item'),
...
vc_map( array(
	...
	'as_child'         => array('only' => 'sc_testimonials'),
	'category'         => esc_html__( 'اختصاصی قالب', 'studiare' ),
	'params'           => array(
		array(
			'type'          => 'textfield',
...
if ( class_exists('WPBakeryShortCodesContainer') ) {
	class WPBakeryShortCode_Sc_Testimonials extends WPBakeryShortCodesContainer {}
}
