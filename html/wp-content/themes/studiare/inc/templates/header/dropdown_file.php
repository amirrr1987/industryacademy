...
<div id="studi_rl_with_sub" class="studi_rl_with_sub">
      
        <a href="#" onclick="menuToggle(event)" class="login-button btn btn-filled">
    ...
    <script>
      function menuToggle(event) {
        ...
        const toggleMenu = document.querySelector(".studi_rl_sub");
        toggleMenu.classList.toggle("active");
      }
      
      jQuery(document).ready(function(){
         
        var mymen = document.getElementById('studi_rl_with_sub');
